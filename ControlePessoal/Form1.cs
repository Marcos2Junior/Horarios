...
namespace ControlePessoal
{
    public partial class Form1 : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void GravaDados(bool encerraDia, string city, string user)
        {
            ...
            MessageBox.Show("Ocorreu tudo como esperado com seus dados, tudo gravado bonitinho e fofinho =)", "Suas alterações foram salvas com sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
